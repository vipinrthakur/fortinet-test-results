...
public class PartitionGroups {
	 ...
	 * @return
	 */
	private static boolean isPartitionPossibleRecursion(List<Integer> list, int[] subsetSum, boolean[] taken, int subset, int k, int size, int currentIndex, int limitIndex) {
